...
module DataMemory(Address, WriteData, Clk, MemWrite, MemRead, ReadData); 
    ...
    if (MemRead)  ReadData = memory[Address[11:2]];
    else ReadData = 0;
    ...
    // ===== DEBUG: DataMemory writes =====
always @(posedge Clk) if (MemWrite) begin
  $display("DMEM WRITE: addr=%h idx=%0d data=%h",
           Address, Address[11:2], WriteData);
end

// ===== DEBUG: DataMemory reads (combinational) =====
always @(*) if (MemRead) begin
  $display("DMEM READ : addr=%h idx=%0d data=%h",
